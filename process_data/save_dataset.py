...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description='Save dataset splits based on classification results.',
    )  

    parser.add_argument(
       "--benchmark",
       type=str, default="medxpertqa-MM",
       choices=["medxpertqa", "medxpertqa-MM", "medqa_4opt", "medqa_5opt", "medmcqa", "afrimedqa"],
       help="Dataset benchmark to process."
    )

    parser.add_argument('--input-file', type=str, default="out/classification/gemini_api/gemini-2.5-flash/medxpertqa-MM/2025-12-05_11-04-09/classification_medxpertqa.jsonl",
                        help='Input file with classified results to process.')
    
    args = parser.parse_args()

    BENCHMARK = args.benchmark  # medqa_4opt, medqa_5opt, medmcqa, afrimedqa, medxpertqa
